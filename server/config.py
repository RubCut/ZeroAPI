...
# Load from zeroapi_config.json if exists
CONFIG_JSON_PATH = Path(__file__).parent.parent / "zeroapi_config.json"
_json_cfg = {}
...
# Server config - priority: env var > json config > default
HOST = os.environ.get("ZEROAPI_HOST", _json_cfg.get("host", "0.0.0.0"))
